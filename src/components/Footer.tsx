        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Authentic Asian cuisine in the heart of Ann Arbor. Experience traditional flavors 
              from Vietnam, China, Korea, and beyond, crafted with passion and served with care.
            </p>
            <div className="flex space-x-4">
              {/* Social Media Links */}
              <a 
                href="https://www.facebook.com/SouthCampusUofM/"
                target="_blank"
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p className="flex items-center">
                ...
                <a href="tel:734-747-7006" className="hover:text-white transition-colors">
                  (734) 747-7006
                </a>
              </p>
